...
process.env.VUE_APP_BOTHUB_NLP_BASE_URL =
  process.env.VUE_APP_BOTHUB_NLP_BASE_URL || 'http://localhost:2657/';
process.env.VUE_APP_BOTHUB_WEBAPP_BASE_URL =
...
process.env.VUE_APP_BOTHUB_WEBAPP_USE_SENTRY =
  process.env.VUE_APP_BOTHUB_WEBAPP_USE_SENTRY || false;
process.env.VUE_APP_SUPPORTED_LANGUAGES =
  process.env.VUE_APP_SUPPORTED_LANGUAGES || 'en|pt_br';
process.env.VUE_APP_BOTHUB_WEBAPP_USE_HOTJAR =
  process.env.VUE_APP_BOTHUB_WEBAPP_USE_HOTJAR || false;
process.env.VUE_APP_BOTHUB_WEBAPP_LIGHTHOUSE_KEY =
  process.env.VUE_APP_BOTHUB_WEBAPP_LIGHTHOUSE_KEY || '';
process.env.VUE_APP_BOTHUB_WEBAPP_LIGHTHOUSE_ALGORITHM_ARTICLE_ID =
  process.env.VUE_APP_BOTHUB_WEBAPP_LIGHTHOUSE_ALGORITHM_ARTICLE_ID || '';
process.env.VUE_APP_BOTHUB_WEBAPP_PAYMENT_ENABLED =
  process.env.VUE_APP_BOTHUB_WEBAPP_PAYMENT_ENABLED || false;
process.env.VUE_APP_BOTHUB_WEBAPP_TUTORIAL_ENABLED =
  process.env.VUE_APP_BOTHUB_WEBAPP_TUTORIAL_ENABLED || false;
...
process.env.VUE_APP_BOTHUB_WEBAPP_SENTRY =
  process.env.VUE_APP_BOTHUB_WEBAPP_SENTRY || '';
process.env.VUE_APP_MAILCHIMP_DATACENTER =
  process.env.VUE_APP_MAILCHIMP_DATACENTER || '';
...
process.env.VUE_APP_LOGROCKET_PARENT_DOMAIN =
  process.env.VUE_APP_LOGROCKET_PARENT_DOMAIN || '';
