<template>
  ...
  >
      ...
      <div v-if="authenticated">
        ...
        >
          <div class="languageTitle">
            <div
              @click="goToTranslationStatus"
              class="languageTitle__back-button"
            >
              <UnnnicIconSvg
          ...
          >
            ...
            <template slot="tab-panel-not_translated">
              <div class="repository-translate"></div>
              <div
                v-if="totalItems.total > 0"
                class="repository-translate__header"
              >
                <div class="translate-description">
                  <h1>{{ $t('webapp.translate.select_sentences_title') }}</h1>
                  <p>
                    {{
                      $t('webapp.translate.select_sentences_subtitle', {
              ...
              <div v-if="!!translate.to">
                ...
                <UnnnicModalNext
                  ...
                  :actionPrimaryLoading="waitDownloadFile"
                >
                ...
                <div class="repository-translate__list">
                  ...
                  <div
                    class="repository-translate__progress"
                    v-if="translating"
                  >
                    <UnnnicModal
                      :showModal="true"
            ...
            <template slot="tab-panel-translated">
              ...
              <div v-if="!!translate.to">
                <div class="repository-translate__list">
                  <div
                    v-if="hasExamplesUntrained.length > 0"
                    class="repository-translate__header"
                  >
                    <div class="translate-description">
                      <UnnnicIconSvg
                      ...
                      <h1>
                        {{
                          $tc(
                            'webapp.translate.examples_untrained',
                            hasExamplesUntrained.length,
                          )
                        }}
                      </h1>
                    </div>
    ...
    <TranslateTokenModal
      ...
      :urlGenerator="externalUrlGenerator"
      :repositoryUuid="repository.uuid"
    />
    <Tour
  ...
  data() {
    return {
      ...
      exportOption: [
        {
          id: 0,
          label: this.$t('webapp.translate.export_all_sentences'),
          value: 'false',
        },
        {
          id: 1,
          label: this.$t('webapp.translate.export_only_translated'),
          value: 'true',
        },
      ],
      query: {},
  ...
  methods: {
    ...
    async importTranslation() {
      ...
      try {
        ...
        this.createXlsxFromJSON(
          data,
          'Weni Artificial Intelligence Response.xlsx',
        );
      } catch (error) {
    ...
    examplesTranslated() {
      ...
      this.update = setTimeout(() => {
        this.$refs.train.updateTrainingStatus();
      }, 2000);
    },
        ...
        this.$buefy.toast.open({
          message: this.$t(
            e.response.status === 500
              ? 'webapp.translate.unsupported'
              : 'webapp.settings.default_error',
          ),
          type: 'is-danger',
        });
        return;
    ...
    async checkProgress(inProgress = false) {
      ...
      setTimeout(() => {
        if (translateStatus.status === 0 || translateStatus.status === 1) {
    ...
    autoTranslateAction() {
      if (this.externalToken)
        return this.autoTranslateExternal({ token: this.externalToken });
