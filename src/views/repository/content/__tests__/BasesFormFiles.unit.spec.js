...
describe('BasesFormFiles.vue', () => {
  ...
  describe('when the component is initialized', () => {
    it('does not show modal delete file', () => {
      const modalDeleteFile = wrapper.find('[data-test="modal-delete-file"]');
  ...
  describe('when user upload no file', () => {
    beforeEach(() => {
  ...
  describe('when user upload a file', () => {
    ...
    describe('when an error occour on create file API', () => {
  ...
  describe('when the user wants to remove a file with error', () => {
    ...
    describe('when the user wants to remove a file', () => {
      ...
      beforeEach(() => {
        ...
        listComponent.vm.$emit('remove', files.data[1]);
      });

      it('should call the remove file', async () => {
        expect(files.removeItem).toHaveBeenCalledWith(
          expect.objectContaining({
            uuid: '2',
          }),
        );
