  ...
  <div class="train">
    ...
    >
      <span
        slot="message"
      >
        Das 125 frases enviadas para treinamento, a IA compreendeu corretamente 102.
...
export default {
  ...
  methods: {
    ...
    async newEvaluate() {
      ...
      this.repository.available_languages.map(async (language) => {
        try {
